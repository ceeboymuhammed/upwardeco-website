...
const steps = ["Waste", "Recovery", "Hubs", "Products", "Aura Store", "Livelihoods"];
    ...
    <section className="py-16 sm:py-20">
      <div className="container-px">
        <div className="max-w-3xl">
          <h2 className="text-2xl font-bold sm:text-3xl">Our Circular Model</h2>
          <p className="mt-3 text-zinc-600">
            A practical flow that links recovery operations to value creation and inclusive livelihoods.
          </p>
        </div>
        ...
        <div className="mt-10 rounded-3xl bg-white p-8 shadow-card ring-1 ring-zinc-200">
          ...
          <div className="mt-6 text-sm leading-relaxed text-zinc-600">
            This model supports both organizational sustainability goals and community-level green enterprise.
          </div>
        </div>
      </div>
    </section>
